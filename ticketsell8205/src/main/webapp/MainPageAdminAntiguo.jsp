...
<% 
	...
	Usuarios usl=(Usuarios) request.getAttribute("loginUser");
        Usuarios userLogged=new Usuarios(); userLogged=usl; 
...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  ...
  <div class="w3-display-middle" style="width:65%">
    <div class="w3-bar w3-black">
      <button class="w3-bar-item w3-button tablink" onclick="openLink(event, 'Flight');"><i class="fa w3-margin-right"></i>Tickets</button>
    </div>
    ...
    <div id="EventS" class="w3-container w3-white w3-padding-16 myLink">
      ...
      <a href="AdvancedSearch.html" class="w3-button w3-dark-grey"><b>Advanced Event Search</b></a>
    </div>
    ...
    <div id="Ticket" class="w3-container w3-white w3-padding-16 myLink">
        ...
        <a href="CreateEvent.html" class="w3-button w3-dark-grey"><b>Create Event</b></a>
      </div>
  </div>
</header>
