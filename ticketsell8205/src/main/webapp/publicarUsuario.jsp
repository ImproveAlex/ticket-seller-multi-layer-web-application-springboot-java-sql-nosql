...
<div>
            ...
            <div class="col-lg-6 py-6 px-5">
                ...
                <form action="SignUpUser.html" class="form" method="post">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <button class="btn btn-primary w-25 py-3" onclick="publicarUsuario()" type="submit" value="Sign up">Crear</button>
                        </div>
    ...
    <!-- Template Javascript -->
    <script >
    function publicarUsuario() {
            var x = document.getElementById("myDIV");
            if (x.style.display === "none") {
                x.style.display = "block";
                document.getElementById("exito-publicar").innerHTML = "Usuario Creado Exitosamente";
            } else {
