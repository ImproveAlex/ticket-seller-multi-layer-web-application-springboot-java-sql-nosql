    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Publica tu entrada</h1>
    ...
    <div class="container-fluid bg-secondary px-0" id="myDIV">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Introduzca los datos del ticket</h1>
                <form action="publicarEntrada.html" method="post" id="request" class="main_form">
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input class="form-control" placeholder="Código de la entrada" type="type" name="codigo">
                                <label for="">Codigo</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input class="form-control" placeholder="Tipo de entrada" type="type" name="tipo_entrada">
                                <label for="">Tipo de entrada</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input class="form-control" placeholder="Precio" type="type" name="precio">
                        ...
                        <div class="col-6">
                            <button class="btn btn-primary w-100 py-3" onclick="modificarEntrada()" type="submit">Modificar</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-primary w-100 py-3" onclick="eliminarEntrada()">Eliminar</button>
                        </div>
    ...
    <script >
        function modificarEntrada() {
                ...
                if (x.style.display === "none") {
                    ...
                    document.getElementById("exito-publicar").innerHTML = "Entrada Modificado Exitosamente";
                } else {
        ...
        function eliminarEntrada() {
                ...
                if (x.style.display === "none") {
                    x.style.display = "block";
                    document.getElementById("exito-publicar").innerHTML = "Entrada Eliminado Exitosamente";
                } else {
                    x.style.display = "none";
                    document.getElementById("exito-publicar").innerHTML = "Entrada Eliminado Exitosamente";
                }
