    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">TicketSeller</h1>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <a href="PublishTicket.html" class="mb-3">Publish Tickets</a>
                    <p class="mb-0">You can use this page to talk to other people and sell you own tickets.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <a href="AdvancedSearch.html" class="mb-3">Advanced Search</a>
                    <p class="mb-0">Find whatever you are looking for.</p>
                </div>
            </div>
