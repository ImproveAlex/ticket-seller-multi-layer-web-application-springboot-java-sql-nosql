            ...
            <div class="col-lg-6 py-6 px-5">
                ...
                <form action="publicarEntrada.html" method="post" id="request" class="main_form">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <button onclick="publicarEntrada()" class="btn btn-primary w-100 py-3">Publicar</button>
                        </div>
    ...
    <script>
        function publicarEntrada() {
            ...
            if (x.style.display === "none") {
                ...
                document.getElementById("exito-publicar").innerHTML = "Entrada Publicada Exitosamente";
            } else {
