    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Crea un usuario</h1>
    ...
    <div class="container-fluid bg-secondary px-0" id="myDIV">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Introduzca los datos del usuario</h1>
                <form action="SignUpUser.html" class="form" method="post">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="name" placeholder="a">
                                <label for="">Name</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="first_surname" placeholder="a">
                                <label for=""">First Surname</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="second_surname" placeholder="a">
                                <label for="">Second Surname</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="phone" placeholder="a">
                                <label for="">Phone Number</label>
                              </div>
                        </div>
						<div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="address" placeholder="a">
                                <label for="">Address</label>
                              </div>
                        </div>
						<div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="username" placeholder="a">
                                <label for="">Username</label>
                              </div>
                        </div>
						<div class="col-12">
                            <div class="form-floating">
                                <input type="password" class="form-control" name="password" placeholder="a">
                                <label for="">Password</label>
                              </div>
                        </div>
						
                        <div class="col-6">
                            <button class="btn btn-primary w-25 py-3" onclick="modificarUsuario()" type="submit" value="Sign up">Modificar</button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-primary w-100 py-3"  onclick="eliminarUsuario()">Eliminar</button>
                        </div>
    ...
    <script >
        function modificarUsuario() {
                ...
                if (x.style.display === "none") {
                    ...
                    document.getElementById("exito-publicar").innerHTML = "Usuario Modificado Exitosamente";
                } else {
        ...
        function eliminarUsuario() {
                ...
                if (x.style.display === "none") {
                    x.style.display = "block";
                    document.getElementById("exito-publicar").innerHTML = "Usuario Eliminado Exitosamente";
                } else {
                    x.style.display = "none";
                    document.getElementById("exito-publicar").innerHTML = "Usuario Eliminado Exitosamente";
                }
